...
global.sudo = process.env.SUDO || "254707213581";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "TECHWIZARD ALWAYS DELIVERS THAT'S RICHIE",
  author: process.env.PACK_AUTHER || "RICHIE",
  packname: process.env.PACK_NAME || "♥️",
  botname: process.env.BOT_NAME || "RICHIEE TECHWIZARD",
  ownername: process.env.OWNER_NAME || "RICHIE THE DON",
